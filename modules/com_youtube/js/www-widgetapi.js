...
// Would have been loaded by https://www.youtube.com/iframe_api
  ...
  function () {
    ...
    function p( a ) {
      ...
      if ( "object" == b ) {
        if ( a ) {
          ...
          if ( "[object Array]" == c || "number" == typeof a.length && "undefined" != typeof a.splice && "undefined" != typeof a.propertyIsEnumerable && !a.propertyIsEnumerable(
              "splice"
            ) ) {
            return "array";
          }
          if ( "[object Function]" == c || "undefined" != typeof a.call && "undefined" != typeof a.propertyIsEnumerable && !a.propertyIsEnumerable(
              "call"
            ) ) {
            return "function"
          }
    ...
    function w( a, b ) {
      ...
      a.W = function (
        ...
        for (
          var h = Array( arguments.length - 2 ), l = 2;
          l < arguments.length;
          l++
        ) {
          h[ l - 2 ] = arguments[ l ];
    ...
    var ga = String.prototype.trim ?
             ...
             }, ha = /&/g, ia = /</g, ja = />/g, ka = /"/g, la = /'/g, ma = /\x00/g, na = /[\x00&<>"']/;
    ...
    function C( a ) {return -1 != B.indexOf( a )}
    ;
    function ua( a, b ) {
      var c = va;
    ...
    ;
    var wa                  = C( "Opera" ), D = C( "Trident" ) || C( "MSIE" ), xa = C(
      "Edge"
    ), E                    = C(
        "Gecko"
      ) && !(
      -1 != B.toLowerCase().indexOf( "webkit" ) && !C( "Edge" )
      ) && !(
      C( "Trident" ) || C( "MSIE" )
      ) && !C( "Edge" ), ya = -1 != B.toLowerCase().indexOf( "webkit" ) && !C(
        "Edge"
      );
    ...
    function Fa( a ) {
      ua(
        ...
        function () {
          for (
            var b = 0, c = ga( String( Ea ) ).split( "." ), d = ga( String( a ) ).split(
              "."
    ...
    var Ga = k.document, Ha = Ga && D ?
                              za() || (
                                "CSS1Compat" == Ga.compatMode ?
                                parseInt( Ea, 10 ) :
                                5
                              ) :
                              void 0;
    ...
    ;
    var Ma = k.JSON.parse, Na = k.JSON.stringify;

    function Oa( a ) {k.setTimeout( function () {throw a;}, 0 )}

    var Pa;

    function Qa() {
      var a = k.MessageChannel;
      "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !C(
        "Presto"
      ) && (
        a = function () {
          ...
          a.write( "" );
          a.close();
          var c = "callImmediate" + Math.random(), d = "file:" == b.location.protocol ?
                                                       "*" :
                                                       b.location.protocol + "//" + b.location.host, a = u(
            function ( a ) {
              if ( (
                  "*" == d || a.origin == d
                ) && a.data ==
    ...
    Sa.prototype.remove = function () {
      var a = null;
      this.a && (
        a = this.a, this.a = this.a.next, this.a || (
          this.b = null
        ), a.next = null
      );
      return a
    ...
    Ta.prototype.reset = function () {this.next = this.b = this.a = null};
    function Va( a ) {
      F || Wa();
      Xa || (
        F(), Xa = !0
    ...
    function Wa() {
      if ( k.Promise && k.Promise.resolve ) {
        ...
        F = function () {a.then( Za )}
      }
      else {
        F = function () {
          var a = Za;
          "function" != p( k.setImmediate ) || k.Window && k.Window.prototype && !C(
            "Edge"
    ...
    function Za() {
      for ( var a; a = Ya.remove(); ) {
        try {a.a.call( a.b )}
        catch ( c ) {Oa( c )}
        var b = Ua;
        b.g( a );
        b.b < b.f && (
          b.b++, a.next = b.a, b.a = a
        )
      }
      Xa = !1
    }
    ...
    function $a( a, b, c ) {
      ...
      if ( a = d.b[ a ] ) {
        ...
        (
          a = pa(
            a,
            function ( a ) {return e[ a + 1 ] == b && e[ a + 2 ] == c}
          )
        ) && d.F( a )
      }
    }
        ...
        if ( this.v ) {
          ...
          try {
            for ( e = 0, f = c.length; e < f; e++ ) {
              h
                = c[ e ], this.a[ h + 1 ].apply( this.a[ h + 2 ], d )
            }
          }
          finally {
    ...
    g.clear = function ( a ) {
      if ( a ) {
        var b = this.b[ a ];
        b && (
          y( b, this.F, this ), delete this.b[ a ]
        )
      }
      else {
    ...
    function db( a ) {
      var b = [], c;
      for ( c in a )cb( c, a[ c ], b );
      b[ 0 ] = "";
      return b.join( "" )
    }

    var eb = /#|$/;
    var J = window.yt && window.yt.config_ || window.ytcfg && window.ytcfg.data_ || {};
    v( "yt.config_", J );
    v( "yt.tokens_", window.yt && window.yt.tokens_ || {} );
    var fb = window.yt && window.yt.msgs_ || m( "window.ytcfg.msgs" ) || {};
    v( "yt.msgs_", fb );
    function gb( a ) {
      var b = arguments;
      if ( 1 < b.length ) {
    ...
    function jb( a, b ) {
      ...
      (
        c = [], c = "ERRORS" in J ? J.ERRORS : c, c.push(
          [
            a,
            b,
            void 0,
    ...
    ;
    var kb = m( "yt.dom.getNextId_" );
    if ( !kb ) {
      kb = function () {return ++lb};
      v( "yt.dom.getNextId_", kb );
      var lb = 0
    }
    ;
    function K( a ) {
      this.type = "";
      this.source = this.data = this.currentTarget = this.relatedTarget
        = this.target = null;
      ...
      if ( a = a || window.event ) {
        ...
        this.charCode = a.charCode || (
            "keypress" == this.type ? this.keyCode : 0
          );
    ...
    K.prototype.preventDefault = function () {
      this.a && (
        this.a.returnValue
          = !1, this.a.preventDefault && this.a.preventDefault()
      )
    };
    K.prototype.stopPropagation = function () {
      this.a && (
        this.a.cancelBubble
          = !0, this.a.stopPropagation && this.a.stopPropagation()
      )
    };
    K.prototype.stopImmediatePropagation = function () {
      this.a && (
        this.a.cancelBubble
          = !0, this.a.stopImmediatePropagation && this.a.stopImmediatePropagation()
      )
    };
    var mb = {
    ...
    var nb = m( "yt.events.counter_" ) || { count : 0 };
    v( "yt.events.counter_", nb );
    function ob( a, b, c ) {
      a.addEventListener && (
        "mouseenter" != b || "onmouseenter" in document ?
        "mouseleave" != b || "onmouseenter" in document ?
        "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (
          b = "MozMousePixelScroll"
        ) :
        b = "mouseout" :
        b = "mouseover"
      );
      return ra( function ( d ) {return d[ 0 ] == a && d[ 1 ] == b && d[ 2 ] == c && 0 == d[ 4 ]} )
    }
    ...
    function pb( a, b, c ) {
      if ( a && (
        ...
        if ( !d ) {
          var d = ++nb.count + "", e = !(
          "mouseenter" != b && "mouseleave" != b || !a.addEventListener || "onmouseenter" in document
          ), f;
          f = e ? function ( d ) {
            d = new K( d );
            if ( !La(
    ...
    function M( a, b ) {
      return "yt:" == a.tagName.toLowerCase().substr( 0, 3 ) ?
             a.getAttribute( b ) :
             a ?
             a.dataset ?
             a.dataset[ sb( b ) ] :
    ...
    function N( a, b, c ) {
      ...
      if ( a = r( a ) ?
        ...
        if ( "iframe" != a.tagName.toLowerCase() && (
            b = yb( this, a ), this.h = a, (
              c = a.parentNode
            ) && c.replaceChild( b, a ), a = b
          ), this.a = a, this.a.id || (
            b = a = this.a, b = b[ t ] || (
                b[ t ] = ++ca
              ), a.id = "widget" + b
          ...
          a = O( this.b, "events" );
          for ( var d in a ) {
            a.hasOwnProperty( d ) && this.addEventListener(
              d,
              a[ d ]
            );
          }
    ...
    g.addEventListener = function ( a, b ) {
      var c = b;
      "string" == typeof b && (
        c = function () {window[ b ].apply( window, arguments )}
      );
    ...
    function yb( a, b ) {
      for (
        var c = document.createElement( "iframe" ), d = b.attributes, e = 0, f = d.length;
        e < f;
        e++
      ) {
        var h = d[ e ].value;
      ...
      c.setAttribute( "title", "YouTube " + O( a.b, "title" ) );
      (
        d = O( a.b, "width" )
      ...
      window.location.host && (
        l.origin = window.location.protocol + "//" + window.location.host
      );
      l.widgetid = a.g;
        ...
        function ( a ) {
          ...
          b:{
            ...
            for (
              ...
              if ( 38 == f || 63 == f ) {
                if ( f
                    = b.charCodeAt( d + e ), !f || 61 == f || 38 == f || 35 == f ) {
                  break b;
                }
              }
              d += e + 1
      ...
      c.src = O( a.b, "host" ) + a.o() + "?" + db( l );
      return c
    }

    g.H = function () {
      this.a && this.a.contentWindow ?
      this.C( { event : "listening" } ) :
    ...
    function Bb( a, b ) {
      a.v[ b ] || (
        a.v[ b ] = !0, Q( a, "addEventListener", [ b ] )
      )
    }
    ...
    g.C = function ( a ) {
      ...
      for ( c = 0; c < b.length; c++ ) {
        try {
          this.a.contentWindow.postMessage(
            a,
            b[ c ]
          )
        }
        catch ( l ) {
          if ( l.name && "SyntaxError" == l.name ) {
            jb( l, "WARNING" );
          }
          else {
            throw l;
    ...
    function Db( a ) {
      ...
      if ( "function" == typeof a.m )return a.m( !1 );
      if ( q( a ) ) {
        var b = 0, c = new S;
        c.next = function () {
          for ( ; ; ) {
            if ( b >= a.length )throw R;
    ...
    function Eb( a, b ) {
      if ( q( a ) ) {
        try {y( a, b, void 0 )}
        catch ( c ) {if ( c !== R )throw c;}
      }
      else {
        a = Db( a );
        try {for ( ; ; )b.call( void 0, a.next(), void 0, a )}
        catch ( c ) {if ( c !== R )throw c;}
      }
    }
    ...
    T.prototype.set = n;
    T.prototype.get = n;
    T.prototype.remove = n;
    function U() {}

    w( U, T );
    U.prototype.m = n;
    U.prototype.clear = function () {
      var a = Fb( this.m( !0 ) ), b = this;
      y( a, function ( a ) {b.remove( a )} )
    };
    ...
    function Gb( a ) {
      if ( !a.a )return;
      try {a.a.setItem( "__sak", "1" ), a.a.removeItem( "__sak" )}
      catch ( b ) {}
    }

    g = V.prototype;
    g.set = function ( a, b ) {
      try {this.a.setItem( a, b )}
      catch ( c ) {
    ...
    g.m = function ( a ) {
      var b = 0, c = this.a, d = new S;
      d.next = function () {
        if ( b >= c.length )throw R;
        var d = c.key( b++ );
        if ( a )return d;
        d = c.getItem( d );
    ...
    g.key = function ( a ) {return this.a.key( a )};
    function Hb() {
      var a = null;
      try {a = window.localStorage || null}
      catch ( b ) {}
      this.a = a
    }
    ...
    function Ib() {
      var a = null;
      try {a = window.sessionStorage || null}
      catch ( b ) {}
      this.a = a
    }
    ...
    function Jb( a ) {
      return (
        0 == a.search( "cue" ) || 0 == a.search( "load" )
        ) && "loadModule" != a
    }
    ...
    function W( a ) {
      ...
      if ( this.b = !!(
        "https:" == document.location.protocol || a && 0 == a.src.indexOf(
          "https:"
        )
        ) ) {
        ...
        for ( var b = 0; b < a.length; b++ ) {
          a[ b ].host && (
            a[ b ].host = a[ b ].host.replace( "http://", "https://" )
          )
        }
      }
    }
    ...
    W.prototype.g = function ( a ) {
      if ( a.origin == O(
          this,
          "host"
        ) || a.origin == O( this, "host" ).replace( /^http:/, "https:" ) ) {
        var b;
        try {b = Ma( a.data )}
        catch ( c ) {return}
        this.f = !0;
        this.b || 0 != a.origin.indexOf( "https:" ) || (
          this.b = !0
        );
        if ( a = P[ b.id ] ) {
          a.B = !0, a.B && (
            y( a.w, a.C, a ), a.w.length = 0
          ), a.J( b )
        }
      }
    };
    ...
    g = X.prototype;
    g.o = function () {return "/embed/" + O( this.b, "videoId" )};
    g.u = function () {
      var a = O( this.b, "playerVars" );
      if ( a ) {
        var b = {}, c;
        for ( c in a )b[ c ] = a[ c ];
        a = b
    ...
    g.J = function ( a ) {
      ...
      switch ( b ) {
        case "apiInfoDelivery":
          if ( ba( a ) )for ( var c in a )this.i[ c ] = a[ c ];
          break;
        case "infoDelivery":
          Nb( this, a );
          break;
          ...
          this[ a ] || (
            ...
            this[ a ] = function () {
              ...
              if ( 1 == this.j.playerState ) {
                var b = (
                  fa() / 1E3 - this.j.currentTimeLastUpdated_
                  ) * this.j.playbackRate;
                0 < b && (
                  a += Math.min( b, 1 )
                )
    ...
    g.V = function () {
      var a             = O(
          this.b,
          "host"
        ) + this.o(), b = '<iframe width="' + O(
          this.b,
          "width"
        ) + '" height="' + O( this.b, "height" ) + '" src="';
      na.test( a ) && (
        -1 != a.indexOf( "&" ) && (
          a = a.replace( ha, "&amp;" )
        ), -1 != a.indexOf( "<" ) && (
      ...
      return b + a + '" frameborder="0" allowfullscreen></iframe>'
    };
    g.U = function ( a ) {
    ...
    function Qb( a ) {
      if ( "iframe" != a.tagName.toLowerCase() ) {
        ...
        if ( b ) {
          ...
          b.width = M( a, "width" );
          b.height = M( a, "height" );
          b.thumbWidth = M( a, "thumb-width" );
          b.thumbHeight = M( a, "thumb-height" );
          b.thumbAlign = M( a, "thumb-align" );
          var c = M( a, "onclick" );
          c && (
            b.events.onClick = c
          );
    ...
    Y.prototype.u = function () {
      return {
        player       : 0,
        thumb_width  : O( this.b, "thumbWidth" ),
        thumb_height : O( this.b, "thumbHeight" ),
        thumb_align  : O( this.b, "thumbAlign" )
      }
    };
    ...
    function Rb( a ) {
      ...
      this.a.width = 640;
      this.a.height = .67 * O( this, "width" )
    }

    w( Rb, W );
    function Z( a, b ) {
      var c = new Rb( b );
      N.call( this, a, c, "upload" )
    }

    w( Z, N );
    g = Z.prototype;
    g.o = function () {return "/upload_embed"};
    g.u = function () {
      var a = {}, b = O( this.b, "webcamOnly" );
      null != b && (
        a.webcam_only = b
      );
      return a
    ...
    g.l = function ( a, b ) {
      Z.D.l.call( this, a, b );
      "onApiReady" == a && Q( this, "hostWindowReady" )
    };
    ...
    g.O = function ( a ) {Q( this, "setVideoTitle", arguments )};
    ...
    v( "YT.get", function ( a ) {return L[ a ]} );
    v( "YT.scan", vb );
    v(
      "YT.subscribe", function ( a, b, c ) {
        I.subscribe( a, b, c );
        ub[ a ] = !0;
        for ( var d in L )Ab( L[ d ], a )
      }
    );
    ...
    v( "YT.Thumbnail", Y );
    v( "YT.UploadWidget", Z );
    N.prototype.destroy = N.prototype.P;
    N.prototype.setSize = N.prototype.S;
    N.prototype.getIframe = N.prototype.R;
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || vb();
    var Sb = m( "onYTReady" );
    Sb && Sb();
    var Tb = m( "onYouTubeIframeAPIReady" );
    Tb && Tb();
    var Ub = m( "onYouTubePlayerAPIReady" );
    Ub && Ub();
  }
)();
